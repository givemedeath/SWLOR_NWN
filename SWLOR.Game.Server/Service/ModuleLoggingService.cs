...
namespace SWLOR.Game.Server.Service
{
    public static class ModuleLoggingService
    {
        ...
        private static void OnModuleEnter()
        {
            ...
            string cdKey = NWScript.GetPCPublicCDKey(oPC.Object);
            string account = NWScript.GetPCPlayerName(oPC.Object);
        ...
        private static void OnModuleNWNXChat()
        {
            ...
            string senderCDKey = NWScript.GetPCPublicCDKey(sender.Object);
            ...
            {
                receiverCDKey =  NWScript.GetPCPublicCDKey(recipient.Object);
        ...
        private static void OnDMAction(int actionTypeID)
        {
            ...
            NWObject dm = NWScript.OBJECT_SELF;

            var record = new DMAction
            {
                DMActionTypeID = actionTypeID,
                Name = dm.Name,
                CDKey = NWScript.GetPCPublicCDKey(dm),
                Details = details
            };
        ...
        private static void OnModuleDeath()
        {
            ...
            var @event = new ModuleEvent
            {
                ...
                CDKey = NWScript.GetPCPublicCDKey(player),
                AccountName = NWScript.GetPCPlayerName(player),
            };
        ...
        {
            NWPlayer player = NWScript.GetLastRespawnButtonPresser();
            var @event = new ModuleEvent
            {
                ModuleEventTypeID = 4,
                PlayerID = player.GlobalID,
        ...
        private static void OnPurchaseLand(OnPurchaseLand message)
        {
            var @event = new ModuleEvent
            {
                ...
                CDKey = NWScript.GetPCPublicCDKey(message.Player),
                AccountName = NWScript.GetPCPlayerName(message.Player),
