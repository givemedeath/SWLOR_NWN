...
namespace SWLOR.Game.Server.Service
{
    public static class AIService
    {
        ...
        {
            string script = GetBehaviourScript(NWScript.OBJECT_SELF);
            if (string.IsNullOrWhiteSpace(script)) return;
            IAIBehaviour behaviour = GetAIBehaviour(script);
            behaviour.OnBlocked(NWScript.OBJECT_SELF);
        }
        ...
        private static void OnCreatureConversation()
        {
            ...
            if (string.IsNullOrWhiteSpace(script)) return;
            IAIBehaviour behaviour = GetAIBehaviour(script);
            behaviour.OnConversation(NWScript.OBJECT_SELF);
        }
        ...
        private static void OnCreatureDamaged()
        {
            ...
            if (string.IsNullOrWhiteSpace(script)) return;
            IAIBehaviour behaviour = GetAIBehaviour(script);
            behaviour.OnDamaged(NWScript.OBJECT_SELF);
        }
        ...
        private static void OnCreatureDeath()
        {
            ...
            if (string.IsNullOrWhiteSpace(script)) return;
            IAIBehaviour behaviour = GetAIBehaviour(script);
            behaviour.OnDeath(NWScript.OBJECT_SELF);
        }
        ...
        private static void OnCreatureDisturbed()
        {
            ...
            if (string.IsNullOrWhiteSpace(script)) return;
            IAIBehaviour behaviour = GetAIBehaviour(script);
            behaviour.OnDisturbed(NWScript.OBJECT_SELF);
        }
        ...
        private static void OnCreatureHeartbeat()
        {
            ...
            if (string.IsNullOrWhiteSpace(script)) return;
            IAIBehaviour behaviour = GetAIBehaviour(script);
            behaviour.OnHeartbeat(NWScript.OBJECT_SELF);
        }
        ...
        private static void OnCreaturePerception()
        {
            ...
            if (string.IsNullOrWhiteSpace(script)) return;
            IAIBehaviour behaviour = GetAIBehaviour(script);
            behaviour.OnPerception(NWScript.OBJECT_SELF);
        }
        ...
        private static void OnCreaturePhysicalAttacked()
        {
            ...
            if (string.IsNullOrWhiteSpace(script)) return;
            IAIBehaviour behaviour = GetAIBehaviour(script);
            behaviour.OnPhysicalAttacked(NWScript.OBJECT_SELF);
        }
        ...
        private static void OnCreatureRested()
        {
            ...
            if (string.IsNullOrWhiteSpace(script)) return;
            IAIBehaviour behaviour = GetAIBehaviour(script);
            behaviour.OnRested(NWScript.OBJECT_SELF);
        }
        ...
        private static void OnCreatureCombatRoundEnd()
        {
            ...
            if (string.IsNullOrWhiteSpace(script)) return;
            IAIBehaviour behaviour = GetAIBehaviour(script);
            behaviour.OnCombatRoundEnd(NWScript.OBJECT_SELF);
        }
        ...
        private static void OnCreatureSpawn()
        {
            ...
            if (self.GetLocalInt("DM_SPAWNED") == NWScript.TRUE) return;
        ...
        private static void OnCreatureSpellCastAt()
        {
            ...
            if (string.IsNullOrWhiteSpace(script)) return;
            IAIBehaviour behaviour = GetAIBehaviour(script);
            behaviour.OnSpellCastAt(NWScript.OBJECT_SELF);
        }
        ...
        private static void OnCreatureUserDefined()
        {
            ...
            if (string.IsNullOrWhiteSpace(script)) return;
            IAIBehaviour behaviour = GetAIBehaviour(script);
            behaviour.OnUserDefined(NWScript.OBJECT_SELF);
        }
