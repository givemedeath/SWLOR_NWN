...
namespace SWLOR.Game.Server.Perk.TwinBlade
{
    public class CrossCut: IPerkHandler
    {
        ...
        public void OnImpact(NWCreature creature, NWObject target, int perkLevel, int spellTier)
        {
            ...
            NWScript.ApplyEffectToObject(DURATION_TYPE_INSTANT, NWScript.EffectDamage(damage, DAMAGE_TYPE_SLASHING), target);
            NWScript.ApplyEffectToObject(DURATION_TYPE_TEMPORARY, NWScript.EffectACDecrease(3), target, duration);
            NWScript.ApplyEffectToObject(DURATION_TYPE_INSTANT, NWScript.EffectVisualEffect(VFX_IMP_HEAD_EVIL), target);
