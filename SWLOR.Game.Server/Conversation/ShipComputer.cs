    ...
    public class ShipComputer: ConversationBase
    {
        ...
        public override void DoAction(NWPlayer player, string pageName, int responseID)
        {
            ...
            if (pageName == "MainPage")
            {
                ...
                else if (response.Text == "Take Off")
                {
                    ...
                    else
                    {
                        ...
                        NWScript.ApplyEffectToObject(DurationType.Instant, NWScript.EffectVisualEffect(356), player);
                        ...
                        if (dock != null)
                        {
                            ...
                            foreach (var plc in areaStructures)
                            {
                                if (plc.PCBaseStructureID == dock.ID)
                                {
                                    ...
                                    NWScript.ApplyEffectToObject(DurationType.Instant, NWScript.EffectVisualEffect(356), plc.Structure);
                                }
            ...
            else if (pageName == "LandingDestPage")
            {
                ...
                if (starport != null)
                {
                    ...
                    {
                        NWScript.TakeGoldFromCreature(starport.Cost, player, 1);
                ...
                else
                {
                    ...
                    NWScript.ApplyEffectAtLocation(DurationType.Instant, NWScript.EffectVisualEffect(356), loc);
                    DoDustClouds(loc);            
                }
        ...
        void DoDustClouds(NWLocation loc)
        {
            ...
            for (int i=0; i < 6; i++)
            {
                ...
                NWPlaceable cloud = NWScript.CreateObject(OBJECT_TYPE_PLACEABLE, "plc_dustplume", NWScript.Location(loc.Area, v, loc.Orientation));
