...
public class LabyrinthLayoutTests
{
    ...
    public void Labyrinth_ProfileRegistration_ComposesLowLoopFactorAndSparseRooms()
    {
        ...
        profile.Template.MinRooms.Should().BeLessThanOrEqualTo(profile.Template.MaxRooms);
        profile.Template.MaxRooms.Should().BeLessThanOrEqualTo(4, "labyrinth chambers should default sparse");
