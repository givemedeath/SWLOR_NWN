...
public class RoadAdjacentDecorationTests
{
    ...
    public void Plan_StreetlightKioskDecoration_MeetsRoadAdjacencyBand(string profileKey)
    {
        ...
        fraction.Should().BeGreaterThanOrEqualTo(MinRoadAdjacencyFraction,
